  ...
  return (
    <section className={styles.coupon}>
      <h2 className={styles.title}>
        Promocja *** Kupon rabatowy <span className={styles.green}>15%!</span>
      </h2>
      <div className={styles.formWrapper}>
        <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
            ...
            render={({ field, fieldState }) => (
              <div className={styles.formItem}>
                ...
                <span className="p-float-label">
                  ...
                  />
                  <label style={{ color: "var(--dark)" }} htmlFor={field.name}>
                    Imię
                  </label>
                </span>
              ...
              <div className={styles.formItem}>
                ...
                <span className="p-float-label">
                  <InputMask
                    ...
                    mask="+48 (999) 999-999"
                  />
                  <label style={{ color: "var(--dark)" }} htmlFor={field.phone}>
                    Telefon
                  </label>
                </span>
                {getFormErrorMessage(field.name)}
          ...
          <p className={styles.subtitle}>
            * Rabat zarezerwowany jest na Twój numer telefonu i obowiązuje
            dokładnie 3 dni od daty otrzymania
          </p>
          <Button
            src="coupon"
            isLoading={isLoading}
